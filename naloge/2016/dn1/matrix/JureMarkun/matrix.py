...
class AbstractMatrix:
    ...
    def multiply(self, left, right):
        ...
        """
        m = left.nrow()  # št.stolpcev prve = št.vrstic druge
        n = left.ncol() #št.vrstic prve
        l = right.nrow()  #št.stolpcev druge
        ...
        for n1 in range(n):
            for l1 in range(l):
                for m1 in range(m):
                    print(n1,m1,l1,"prva")
                #    print(left[l][a],right[a][b])
                    matrika[l1,n1] += left[n1,m1]*right[m1,l1]
        return matrika
